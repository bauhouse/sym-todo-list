...
CREATE TABLE`tbl_sections` (
  ...
  `modification_author_id` int(11) unsigned NOT NULL DEFAULT 1,
  `creation_date` datetime NOT NULL DEFAULT '2020-04-18 12:53:11',
  `creation_date_gmt` datetime NOT NULL DEFAULT '2020-04-18 19:53:11',
  `modification_date` datetime NOT NULL DEFAULT '2020-04-18 12:53:11',
  `modification_date_gmt` datetime NOT NULL DEFAULT '2020-04-18 19:53:11',
  PRIMARY KEY (`id`),
...
CREATE TABLE`tbl_sessions` (
  `session` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
